 ...
 *
 * WHAT:    Boots the app against a clean postgres:16-alpine container and
 *          asserts that all Liquibase changesets applied and seed data landed.
 * WHY:     This catches the case where a developer forgot to commit a new
 *          changeset XML — running on a fresh container fails immediately.
 * OBSERVE: databasechangelog has >= 13 rows (Day 1-5 changesets) and trades
 *          has >= 10 non-deleted seed rows.
 * ============================================================================
 */
@Testcontainers
@SpringBootTest
