...
> **Level:** 2 (Container)
> **Scope:** Runtime containers (independently deployable processes) inside the ReconX boundary, plus surrounding external actors.
> **Audience:** Developers, DevOps/SREs, architects explaining the deployment topology and Docker Compose stack.
