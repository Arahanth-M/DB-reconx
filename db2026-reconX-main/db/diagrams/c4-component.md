...
> **Level:** 3 (Component)
> **Scope:** Zooming into a single container (`recon-service API`) to show its internal logical components (Spring stereotypes).
> **Audience:** Backend engineers and maintainers working on Java code and package architecture.
